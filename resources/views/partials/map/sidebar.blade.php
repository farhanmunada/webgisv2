...
<aside id="sidebar-drawer" class="fixed top-0 left-0 h-full w-72 bg-white z-[70] transform -translate-x-full transition-transform duration-300 shadow-2xl flex flex-col">
    ...
    <div class="p-6 border-b border-slate-50 flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="font-black text-slate-900 tracking-tight">Kopi Temanggung</span>
        </div>
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('guide') }}" class="flex items-center gap-4 px-4 py-4 rounded-2xl text-slate-600 hover:bg-slate-50 transition-all group">
            <div class="p-2 rounded-xl bg-slate-50 group-hover:bg-[#8B4513]/10 transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                </svg>
            </div>
            <span class="font-bold text-sm">Petunjuk & Ketentuan</span>
        </a>
    </nav>
