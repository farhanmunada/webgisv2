<x-admin-layout>
    ...
    <div class="max-w-5xl">
        <div class="mb-8 flex items-center justify-between">
            ...
            <div class="px-4 py-1.5 bg-amber-50 rounded-full border border-amber-100">
                <span class="text-[10px] font-black uppercase text-[#8B4513] tracking-widest">Penambahan Data Baru</span>
            </div>
        </div>

        <form action="{{ route('admin.umkm.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            @csrf
                    ...
                    <div class="p-5 sm:p-8 border-b border-slate-50">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            <div>
                                ...
                                <p class="text-slate-500 text-xs mt-1">Klik pada peta untuk menentukan koordinat UMKM</p>
                            </div>
            ...
            <div class="space-y-8">
                <div class="bg-white rounded-2xl sm:rounded-3xl border border-slate-100 shadow-sm p-5 sm:p-8">
                    ...
                    <div class="space-y-4">
                        <div id="image-preview" class="w-full aspect-video rounded-2xl bg-slate-50 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center p-4 text-center overflow-hidden">
                            ...
                            <p class="text-xs text-slate-400">Pilih foto terbaik untuk mewakili UMKM</p>
                        </div>
                ...
                <div class="bg-white rounded-2xl sm:rounded-3xl border border-slate-100 shadow-sm p-5 sm:p-8 sticky top-8">
                    ...
                    <p class="text-[10px] text-center text-slate-400 mt-4 px-2">Data akan dipublikasikan langsung ke peta publik.</p>
                </div>
            </div>
        </form>
    </div>
    ...
    <script>
        let map, marker;
        const defaultCenter = { lat: -7.3274, lng: 110.1772 }; // Temanggung
        ...
        function updatePosition(latLng, updateInputs = true) {
